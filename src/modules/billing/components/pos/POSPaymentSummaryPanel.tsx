    ...
    <div className="w-full md:w-96 bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 flex flex-col justify-between shrink-0 sticky top-6 self-start max-h-[90vh] overflow-y-auto space-y-6">
      <div className="space-y-5">
        ...
        <div className="space-y-3 pt-1">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                ...
                className="text-[11px] font-extrabold text-cyan-700 bg-cyan-50 border border-cyan-200 px-2.5 py-1 rounded-lg hover:bg-cyan-100 transition-colors cursor-pointer flex items-center gap-1"
              >
                ⚡ Paid in Full
              </button>
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 pr-4 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 text-sm font-bold font-mono text-slate-900 bg-white"
              />
            </div>
          </div>
          ...
          {pAmount > grandTotal ? (
            <div className="p-3 rounded-xl border border-emerald-200 bg-emerald-50 text-emerald-950 flex items-center justify-between text-xs font-bold animate-fade-in">
            ...
            <div className="p-3 rounded-xl border flex items-center justify-between text-xs font-bold transition-all">
              ...
              {balanceDue <= 0 ? (
                <span className="inline-flex items-center gap-1 text-cyan-800 bg-cyan-50 px-2.5 py-1 rounded-lg border border-cyan-200 font-mono text-xs font-bold">
                  <CheckCircle2 className="w-4 h-4 text-cyan-600" /> ₹0.00 (Fully Paid)
                </span>
              ) : (
                <span className="inline-flex items-center gap-1 text-amber-800 bg-amber-50 px-2.5 py-1 rounded-lg border border-amber-200 font-mono text-xs font-bold">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 text-xs font-bold bg-white"
              >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500 text-xs font-medium"
            />
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 pt-3 border-t border-slate-100">
        ...
        <div className="relative group">
          <button
            ...
            className="w-full bg-cyan-600 hover:bg-cyan-700 text-white font-extrabold py-3 rounded-xl transition shadow-lg shadow-cyan-600/20 text-xs uppercase tracking-wider cursor-pointer disabled:bg-slate-200 disabled:text-slate-400 disabled:shadow-none flex items-center justify-center gap-1.5"
          >
